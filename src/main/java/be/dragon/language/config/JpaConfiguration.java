package be.dragon.language.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "be.dragon.language.repositorys",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "be.dragon.language.model" });
